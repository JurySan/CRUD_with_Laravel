      ...
      <form  class="form-horizontal"  method="post">
        ...
        <fieldset>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-10">
              <input type="text" name="title" class="form-control" placeholder="Title"  value="{{$tickets->title}}"  >
            </div>
          </div>
          <div class="form-group">
            <label for="title" class="col-lg-2 control-label">Content</label>
            <div class="col-lg-10">
              <textarea class="form-control" id="content" row="3" name="content" placeholder>{{$tickets->content}}</textarea>
